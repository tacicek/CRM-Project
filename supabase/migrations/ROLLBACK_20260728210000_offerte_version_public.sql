-- =============================================================================
-- ROLLBACK für 20260728210000_offerte_version_public.sql
--
-- NICHT als reguläre Migration ausführen.
--
-- ⚠️ Danach kann ein Kunde eine ÜBERHOLTE Fassung annehmen — und der Auftrag
--    entstünde aus einem Umfang, den die Firma bereits ersetzt hat. Die
--    öffentliche Seite verliert ausserdem den Hinweis, dass sie eine alte
--    Fassung zeigt.
--
-- Die beiden Rümpfe unten sind der Stand aus der Produktion vor dieser
-- Migration, wörtlich ausgelesen.
-- =============================================================================
