-- =============================================
-- FIX: Add form_version and detailed_form_data to submit_lead_json
-- This critical fix ensures all wizard form data is properly saved
-- =============================================

-- Drop and recreate the function with all necessary fields
...
BEGIN
  INSERT INTO public.leads (
    ...
    ip_address,
    status,
    -- NEW: Form versioning and detailed data
    form_version,
    detailed_form_data
  ) VALUES (
...
COMMENT ON FUNCTION public.submit_lead_json IS 'Flexible lead submission function with form_version and detailed_form_data support. Accepts all form data as JSONB and bypasses RLS using SECURITY DEFINER.';
