-- ============================================================
-- get_offer_by_token: RETURNS TABLE'a surcharges jsonb eklendi.
-- RETURNS TABLE değiştiği için DROP + CREATE zorunlu (CREATE OR REPLACE yetmez).
-- Gövde canlı tanımdan birebir korundu; sadece sona o.surcharges eklendi.
-- DROP grant'leri sildiği için anon/authenticated/service_role EXECUTE re-grant edilir
-- (public token RPC — anon erişimi şart).
-- ============================================================
