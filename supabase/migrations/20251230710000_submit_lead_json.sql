-- =============================================
-- CREATE FLEXIBLE LEAD SUBMISSION FUNCTION
-- Accepts all form data as JSONB to bypass RLS
-- =============================================

-- Drop existing functions
DROP FUNCTION IF EXISTS public.submit_lead_json;

-- Create flexible function that accepts all data as JSONB
...
COMMENT ON FUNCTION public.submit_lead_json IS 'Flexible lead submission function. Accepts all form data as JSONB and bypasses RLS using SECURITY DEFINER.';
