-- =============================================
-- Change submit_lead_json return type from UUID to TEXT (slug)
-- This makes the customer-facing Anfrage-Nummer consistent with admin/firma panel (ANF-YYYY-XXXXXX)
-- =============================================

-- Must drop first because return type changes UUID → TEXT
...
COMMENT ON FUNCTION public.submit_lead_json(JSONB) IS 'Public lead insert; returns slug (ANF-YYYY-XXXXXX) for display to customer. Status always pending_verification until admin verifies.';
