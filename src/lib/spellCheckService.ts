 ...
 * wird (`offers.language`), NICHT die Dashboard-Sprache des Bedieners. Bis
 * 2026-08-28 wurde sie gar nicht mitgeschickt, und die Edge Function trug einen
 * fest deutschen Prompt: eine franzoesische Offerte lief durch `ß → ss` und die
 * deutsche Substantivgrossschreibung.
 *
 * Sie ist deshalb ein Pflichtargument und kein Standardwert. Ein Standardwert
 * waere derselbe stille Rueckfall auf Deutsch, nur eine Ebene hoeher.
 */
