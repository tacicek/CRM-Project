// Step10NewFloor.tsx - New property floor level
...
export const Step10NewFloor = ({ data, onChange }: Step10Props) => {
          ...
          <div className="flex items-start gap-3">
            ...
            <p className="text-sm text-gray-600">
              ...
              {data.stockwerk === 'floor_5_plus' && (
                <>
                  <strong>5.+ Stock:</strong> Bei hohen Stockwerken planen wir 
                  zusätzliche Zeit ein oder empfehlen einen Möbellift.
                </>
              )}
              {(data.stockwerk === 'floor_1' || data.stockwerk === 'floor_2' || 
                data.stockwerk === 'floor_3' || data.stockwerk === 'floor_4') && (
                <>
                  Das Stockwerk wird bei der Kalkulation berücksichtigt.
                </>
              )}
