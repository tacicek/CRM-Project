...
Steinway Flügel, ca. 350kg`,
  ...
  // --- Inbound-E-Mail-Eingang (Review-Queue) ----------------------------------------
  "lead.inbox.pageTitle": "E-Mail-Eingang · CRM",
  "lead.inbox.title": "E-Mail-Eingang",
  "lead.inbox.subtitle":
    "Automatisch ausgewertete Kundenmails. Prüfen, korrigieren und als Anfrage übernehmen.",
  "lead.inbox.tab.needsReview": "Zu prüfen",
  "lead.inbox.tab.converted": "Übernommen",
  "lead.inbox.tab.rejected": "Abgelehnt",
  "lead.inbox.tab.failed": "Fehlgeschlagen",
  "lead.inbox.empty": "Keine E-Mails in dieser Ansicht.",
  "lead.inbox.noSubject": "(kein Betreff)",
  "lead.inbox.loadFailed": "E-Mails konnten nicht geladen werden.",
  "lead.inbox.confidence": "Sicherheit",
  "lead.inbox.attempts": "{count} Versuche",
  "lead.inbox.attempts#one": "{count} Versuch",
  "lead.inbox.missingFields": "Fehlende Angaben",
  "lead.inbox.preview": "Nachricht",
  "lead.inbox.noPreview": "Kein Textinhalt gespeichert.",
  "lead.inbox.attachments": "Anhänge",
  "lead.inbox.extractedTitle": "Erkannte Angaben",
  "lead.inbox.extractedHint":
    "Vor der Übernahme prüfen — die KI ergänzt nichts, was nicht in der Mail stand.",
  "lead.inbox.approve": "Als Anfrage übernehmen",
  "lead.inbox.reject": "Ablehnen",
  "lead.inbox.retry": "Erneut verarbeiten",
  "lead.inbox.approved": "Anfrage erstellt",
  "lead.inbox.approvedHint": "Die E-Mail wurde mit der neuen Anfrage verknüpft.",
  "lead.inbox.approveFailed": "Übernahme fehlgeschlagen",
  "lead.inbox.rejected": "E-Mail abgelehnt",
  "lead.inbox.rejectedByOperator": "Manuell abgelehnt",
  "lead.inbox.retried": "Erneut verarbeitet",
  "lead.inbox.retryFailed": "Erneute Verarbeitung fehlgeschlagen",
  "lead.inbox.openLead": "Zur Anfrage",
  "lead.inbox.noExtraction": "Für diese E-Mail liegen keine erkannten Angaben vor.",
  "lead.inbox.status.leadCreated": "Anfrage erstellt",
  "lead.inbox.status.needsReview": "Zur Prüfung vorgemerkt",
  "lead.inbox.status.rejected": "Abgelehnt",
  "lead.inbox.status.failed": "Fehlgeschlagen",
} as const;
