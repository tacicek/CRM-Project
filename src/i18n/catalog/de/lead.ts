...
Steinway Flügel, ca. 350kg`,
  ...
  // --- Pipeline und Wiedervorlage (20260728240000) -----------------------
  "task.pageTitle": "Wiedervorlage · CRM",
  "task.title": "Wiedervorlage",
  "task.count": "{count} offene Aufgaben",
  "task.count#one": "{count} offene Aufgabe",
  "task.count#other": "{count} offene Aufgaben",
  "task.empty": "Nichts offen",
  "task.emptyHint": "Neue Aufgaben entstehen automatisch — etwa wenn eine Offerte fünf Tage ohne Antwort bleibt.",
  "task.filter.open": "Offen",
  "task.filter.overdue": "Überfällig",
  "task.filter.done": "Erledigt",
  "task.filter.all": "Alle",
  "task.markDone": "Erledigt",
  "task.markOpen": "Wieder öffnen",
  "task.doneToast": "Als erledigt markiert",
  "task.due": "fällig",
  "task.overdue": "überfällig",
  "task.noDue": "ohne Frist",
  "task.type.follow_up": "Nachfassen",
  "task.type.call": "Anruf",
  "task.type.offer": "Offerte",
  "task.type.inspection": "Besichtigung",
  "task.type.admin": "Verwaltung",
  "task.type.lost_reason": "Verlustgrund",
  "task.type.cross_sell": "Zusatzangebot",
  "task.priority.low": "niedrig",
  "task.priority.normal": "normal",
  "task.priority.high": "hoch",
  "task.open.lead": "Zur Anfrage",
  "task.open.offer": "Zur Offerte",
  "stage.new": "Neu",
  "stage.qualifying": "Qualifizierung",
  "stage.inspection": "Besichtigung",
  "stage.offer_draft": "Offerte in Arbeit",
  "stage.offer_sent": "Offerte versendet",
  "stage.negotiating": "In Verhandlung",
  "stage.won": "Gewonnen",
  "stage.lost": "Verloren",
  "stage.label": "Verkaufsstufe",
  "lost.price": "Preis",
  "lost.timing": "Termin",
  "lost.competitor": "Mitbewerber",
  "lost.no_response": "Keine Rückmeldung",
  "lost.out_of_area": "Ausserhalb des Gebiets",
  "lost.scope": "Leistungsumfang",
  "lost.other": "Anderes",
