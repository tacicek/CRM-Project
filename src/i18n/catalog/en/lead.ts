...
Steinway grand piano, approx. 350 kg`,
  ...
  "lead.inbox.pageTitle": "Email inbox · CRM",
  "lead.inbox.title": "Email inbox",
  "lead.inbox.subtitle":
    "Customer emails parsed automatically. Review, correct and turn into a request.",
  "lead.inbox.tab.needsReview": "To review",
  "lead.inbox.tab.converted": "Converted",
  "lead.inbox.tab.rejected": "Rejected",
  "lead.inbox.tab.failed": "Failed",
  "lead.inbox.empty": "No emails in this view.",
  "lead.inbox.noSubject": "(no subject)",
  "lead.inbox.loadFailed": "Emails could not be loaded.",
  "lead.inbox.confidence": "Confidence",
  "lead.inbox.attempts": "{count} attempts",
  "lead.inbox.attempts#one": "{count} attempt",
  "lead.inbox.missingFields": "Missing details",
  "lead.inbox.preview": "Message",
  "lead.inbox.noPreview": "No text content stored.",
  "lead.inbox.attachments": "Attachments",
  "lead.inbox.extractedTitle": "Detected details",
  "lead.inbox.extractedHint":
    "Check before converting — the AI adds nothing that was not in the email.",
  "lead.inbox.approve": "Convert to request",
  "lead.inbox.reject": "Reject",
  "lead.inbox.retry": "Process again",
  "lead.inbox.approved": "Request created",
  "lead.inbox.approvedHint": "The email has been linked to the new request.",
  "lead.inbox.approveFailed": "Conversion failed",
  "lead.inbox.rejected": "Email rejected",
  "lead.inbox.rejectedByOperator": "Rejected manually",
  "lead.inbox.retried": "Processed again",
  "lead.inbox.retryFailed": "Reprocessing failed",
  "lead.inbox.openLead": "Open request",
  "lead.inbox.noExtraction": "No detected details for this email.",
  "lead.inbox.status.leadCreated": "Request created",
  "lead.inbox.status.needsReview": "Queued for review",
  "lead.inbox.status.rejected": "Rejected",
  "lead.inbox.status.failed": "Failed",
  // --- Pipeline und Wiedervorlage (20260728240000) -----------------------
  "task.pageTitle": "Follow-ups · CRM",
  "task.title": "Follow-ups",
  "task.count": "{count} open tasks",
  "task.count#one": "{count} open task",
  "task.count#other": "{count} open tasks",
  "task.empty": "Nothing open",
  "task.emptyHint": "Tasks are created automatically — for example when an offer goes five days without a reply.",
  "task.filter.open": "Open",
  "task.filter.overdue": "Overdue",
  "task.filter.done": "Done",
  "task.filter.all": "All",
  "task.markDone": "Done",
  "task.markOpen": "Reopen",
  "task.doneToast": "Marked as done",
  "task.due": "due",
  ...
  "task.type.lost_reason": "Loss reason",
  "task.type.cross_sell": "Cross-sell",
  "task.priority.low": "low",
  "task.priority.normal": "normal",
  "task.priority.high": "high",
  "task.open.lead": "Go to enquiry",
  "task.open.offer": "Go to offer",
  "stage.new": "New",
  "stage.qualifying": "Qualifying",
  "stage.inspection": "Inspection",
  "stage.offer_draft": "Offer in progress",
  "stage.offer_sent": "Offer sent",
  "stage.negotiating": "Negotiating",
  "stage.won": "Won",
  "stage.lost": "Lost",
  "stage.label": "Sales stage",
  "lost.price": "Price",
  "lost.timing": "Timing",
  "lost.competitor": "Competitor",
  "lost.no_response": "No response",
  "lost.out_of_area": "Out of area",
  "lost.scope": "Scope",
  "lost.other": "Other",
