...
Piano à queue Steinway, env. 350 kg`,
  ...
  "task.pageTitle": "Suivi · CRM",
  "task.title": "Suivi",
  "task.count": "{count} tâches ouvertes",
  "task.count#one": "{count} tâche ouverte",
  "task.count#other": "{count} tâches ouvertes",
  "task.empty": "Rien en attente",
  "task.emptyHint": "Les tâches se créent automatiquement — par exemple quand une offre reste cinq jours sans réponse.",
  "task.filter.open": "Ouvertes",
  "task.filter.overdue": "En retard",
  "task.filter.done": "Terminées",
  "task.filter.all": "Toutes",
  "task.markDone": "Terminé",
  "task.markOpen": "Rouvrir",
  "task.doneToast": "Marquée comme terminée",
  "task.due": "échéance",
  "task.overdue": "en retard",
  "task.noDue": "sans échéance",
  "task.type.follow_up": "Relance",
  "task.type.call": "Appel",
  "task.type.offer": "Offre",
  "task.type.inspection": "Visite",
  "task.type.admin": "Administration",
  "task.type.lost_reason": "Motif de perte",
  "task.type.cross_sell": "Offre complémentaire",
  "task.priority.low": "basse",
  "task.priority.normal": "normale",
  "task.priority.high": "haute",
  "task.open.lead": "Vers la demande",
  "task.open.offer": "Vers l'offre",
  "stage.new": "Nouveau",
  "stage.qualifying": "Qualification",
  "stage.inspection": "Visite",
  "stage.offer_draft": "Offre en cours",
  "stage.offer_sent": "Offre envoyée",
  "stage.negotiating": "En négociation",
  "stage.won": "Gagné",
  "stage.lost": "Perdu",
  "stage.label": "Étape de vente",
  "lost.price": "Prix",
  "lost.timing": "Date",
  "lost.competitor": "Concurrent",
  "lost.no_response": "Sans réponse",
  "lost.out_of_area": "Hors zone",
  "lost.scope": "Étendue des prestations",
  "lost.other": "Autre",
