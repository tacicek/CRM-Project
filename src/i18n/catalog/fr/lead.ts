...
Piano à queue Steinway, env. 350 kg`,
  ...
  "lead.inbox.pageTitle": "Boîte e-mail · CRM",
  "lead.inbox.title": "Boîte e-mail",
  "lead.inbox.subtitle":
    "E-mails clients analysés automatiquement. Vérifiez, corrigez et convertissez en demande.",
  "lead.inbox.tab.needsReview": "À vérifier",
  "lead.inbox.tab.converted": "Converties",
  "lead.inbox.tab.rejected": "Refusées",
  "lead.inbox.tab.failed": "En échec",
  "lead.inbox.empty": "Aucun e-mail dans cette vue.",
  "lead.inbox.noSubject": "(sans objet)",
  "lead.inbox.loadFailed": "Impossible de charger les e-mails.",
  "lead.inbox.confidence": "Confiance",
  "lead.inbox.attempts": "{count} tentatives",
  "lead.inbox.attempts#one": "{count} tentative",
  "lead.inbox.missingFields": "Informations manquantes",
  "lead.inbox.preview": "Message",
  "lead.inbox.noPreview": "Aucun contenu texte enregistré.",
  "lead.inbox.attachments": "Pièces jointes",
  "lead.inbox.extractedTitle": "Informations détectées",
  "lead.inbox.extractedHint":
    "À vérifier avant la reprise — l'IA n'ajoute rien qui ne figurait pas dans l'e-mail.",
  "lead.inbox.approve": "Convertir en demande",
  "lead.inbox.reject": "Refuser",
  "lead.inbox.retry": "Retraiter",
  "lead.inbox.approved": "Demande créée",
  "lead.inbox.approvedHint": "L'e-mail a été lié à la nouvelle demande.",
  "lead.inbox.approveFailed": "Échec de la reprise",
  "lead.inbox.rejected": "E-mail refusé",
  "lead.inbox.rejectedByOperator": "Refusé manuellement",
  "lead.inbox.retried": "Retraité",
  "lead.inbox.retryFailed": "Échec du retraitement",
  "lead.inbox.openLead": "Voir la demande",
  "lead.inbox.noExtraction": "Aucune information détectée pour cet e-mail.",
  "lead.inbox.status.leadCreated": "Demande créée",
  "lead.inbox.status.needsReview": "En attente de vérification",
  "lead.inbox.status.rejected": "Refusé",
  "lead.inbox.status.failed": "En échec",
};
